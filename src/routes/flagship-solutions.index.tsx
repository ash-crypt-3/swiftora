    ...
    <>
      ...
      <section style={{ background: "#f7f6f2", padding: "80px 0" }}>
        ...
        >
          ...
          {/* CTA card — identical layout to solution cards */}
          <div
            style={{ background: "#ffffff", borderTop: "3px solid #D5AF34", borderRadius: 4, overflow: "hidden", height: "100%", display: "flex", flexDirection: "column" }}
          >
            {/* Card image */}
            <div style={{ height: 200, overflow: "hidden", flexShrink: 0 }}>
              <img
